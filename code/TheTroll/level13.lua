...
function init_level13()
	...
	function proceed_next()
		...
		question_text_3 = display.newText( question_block_group, "How many circles?", phone_middle_x, q_window_middle_point_y, DEFAULT_FONT, 19 )
		question_text_4 = display.newText( question_block_group, "were there?", phone_middle_x, q_window_middle_point_y + 15, DEFAULT_FONT, 19 )
