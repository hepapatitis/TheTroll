...
function init_level15()
	...
	function proceed_next()
		...
		question_text_3 = display.newText( question_block_group, "How many 'o' were there?", phone_middle_x, q_window_middle_point_y, DEFAULT_FONT, 19 )
