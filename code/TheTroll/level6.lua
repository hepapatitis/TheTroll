...
function init_level6()
	...
	function create_question()
		...
		question_text_2 = display.newText( game_scene_block_group, "Pay attention to this word", phone_middle_x, q_window_middle_point_y - 35, DEFAULT_FONT, 18 )
	...
	function proceed_next()
		...
		question_text_3 = display.newText( game_scene_block_group, "What was the word?", phone_middle_x, q_window_middle_point_y, DEFAULT_FONT, 20 )
