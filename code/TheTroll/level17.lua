...
function init_level17()
	...
	function create_question()
		...
		local random_selection = math.random(1,3) -- NOTE: Only 3 Answers are correct
	...
	function proceed_next()
		...
		question_text_3 = display.newText( question_block_group, "How many vowel were there?", phone_middle_x, q_window_middle_point_y - 8, DEFAULT_FONT, 19 )
		question_text_4 = display.newText( question_block_group, "How many vowel were there?", phone_middle_x, q_window_middle_point_y + 7, DEFAULT_FONT, 19 )
