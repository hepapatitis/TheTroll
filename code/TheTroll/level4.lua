...
function init_level4()
	...
	function create_question()
		...
		question_text_2 = display.newText( question_block_group, "Take a look at", phone_middle_x, q_window_middle_point_y - 35, DEFAULT_FONT, 24 )
	...
	function proceed_next()
		...
		question_text_3 = display.newText( question_block_group, "What is the total?", phone_middle_x, q_window_middle_point_y, DEFAULT_FONT, 20 )
