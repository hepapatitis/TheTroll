...
function init_level1()
	...
	function create_question()
		...
		question_text = display.newText( game_scene_block_group, q_set[random_selection], phone_middle_x, q_window_middle_point_y +15, DEFAULT_FONT, 50 )
		question_text_2 = display.newText( game_scene_block_group, "What is", phone_middle_x, q_window_middle_point_y - 35, DEFAULT_FONT, 24 )
