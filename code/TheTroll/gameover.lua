...
function create_gameover()
	...
	question_text_2 = display.newText( game_scene_block_group, "Tadaaa, wrong answer", phone_middle_x, q_window_middle_point_y - 35, DEFAULT_FONT, 20 )
	question_label = display.newText( game_scene_block_group, "Game Over", phone_middle_x, q_window_middle_point_y - 85, DEFAULT_FONT, 21 )
