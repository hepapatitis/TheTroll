...
function init_gamedone(lv)
	...
	function create_gamedone()
		...
		question_text = display.newText( game_scene_block_group, "Last Level: "..level, phone_middle_x, q_window_middle_point_y + 15, DEFAULT_FONT, 21 )
		question_text_2 = display.newText( game_scene_block_group, "You've finished", phone_middle_x, q_window_middle_point_y - 35, DEFAULT_FONT, 18 )
		question_text_3 = display.newText( game_scene_block_group, "the whole level", phone_middle_x, q_window_middle_point_y - 20, DEFAULT_FONT, 18 )
		question_label = display.newText( game_scene_block_group, "Congrats!", phone_middle_x, q_window_middle_point_y - 85, DEFAULT_FONT, 18 )
